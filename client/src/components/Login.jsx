...
const Login = ({ loginFirst, setLoginFirst }) => {
    ...
    return (
        <div className="bg-gray-50 p-6 rounded-lg w-full sm:max-w-96">
            <div className="flex justify-center items-center mb-6">
                <span className="font-semibold text-2xl text-gray-900"> Login </span>
            </div>
            ...
            <button type="button" className="flex justify-center items-center w-full uppercase bg-purple-700 text-gray-50 py-3.5 transition-all rounded-full hover:bg-purple-600" onClick={login} disabled={status == "loading" ? true : false}> {status == "loading" ? (                    
